...
| **Europa Universalis V** | 1.0.x <sup>[3](#note-3)</sup><br>1.1.x <sup>[4](#note-4)</sup><br>1.2.x<br>1.3.0, 1.3.2, 1.3.4, 1.3.6, 1.3.8, 1.3.10, 1.3.11 <sup>[5](#note-5)</sup> | 100% |
...
2. <a id="note-2"></a> Within 4.4.x, smoked coverage is 4.4.1, 4.4.3, 4.4.4, and 4.4.5; 4.4.0 was skipped by Paradox and the 4.4.2 hotfix wasn't run — 4.4.3 superseded it shortly after and the same files parse clean, so those builds are claimed against 4.4.3/4.4.4/4.4.5.
...
5. <a id="note-5"></a> 1.3.x builds are listed individually rather than as a range: 1.3.0–1.3.10 were the open beta, with 1.3.10 doubling as the first official (non-beta) release, and 1.3.11 is the second official release. Within the beta, 1.3.0 was the initial open beta; 1.3.1, 1.3.3, 1.3.5, 1.3.7, and 1.3.9 were skipped by Paradox; and 1.3.2, 1.3.4, 1.3.6, 1.3.8, and 1.3.10 are the smoked beta patches. Every 1.2.0+ `BUILD_VERSION_MAP` entry keys on the disk-checksum suffix read from the install, since Paradox obfuscates the publicly-displayed checksum from 1.2.0 on (1.3.6 had no official checksum at all — in-game value `872e`; 1.3.8's is `98b8`, 1.3.10's is `c764`, 1.3.11's is `b08d`).
